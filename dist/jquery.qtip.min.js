...
1)},position:function(h,o){var c=s.tip,v={},B=Math.max(0,k.offset),g,d,f;if(k.corner===n||!c)return n;h=h||q.corner;g=h.precedance;d=j(h)[g==="x"?"width":"height"];f=a.browser.msie&&z&&/^(b|r)/i.test(h.string())?1:0;a.each(g==="y"?[h.x,h.y]:[h.y,h.x],function(i,p){var r,t;if(p==="center"){r=g==="y"?"left":"top";v[r]="50%";v["margin-"+r]=-Math.round(d/2)+B}else{r=m(h,p,w);t=a.browser.mozilla;var D=h.y+(t?"":"-")+h.x;t=(t?"-moz-":a.browser.webkit?"-webkit-":"")+(t?"border-radius-"+D:"border-"+D+"-radius");
