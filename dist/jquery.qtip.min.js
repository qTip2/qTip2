...
FALSE){f[j]();n()}else f.fadeTo(90,e?100:0,n);e&&i.target.trigger("qtip-"+k+"-inactive");return d},show:function(e){d.toggle(TRUE,e)},hide:function(e){d.toggle(FALSE,e)},focus:function(e){if(!d.rendered)return FALSE;var h=d.elements.tooltip,n=parseInt(h.css("z-index"),10),j=a.fn.qtip.zindex+a(".qtip.ui-tooltip").length,f=a.extend({},e);if(!h.hasClass("ui-tooltip-focus")&&n!==j){a(".qtip.ui-tooltip").each(function(){var i=a(this).qtip(),l=a.Event("tooltipblur"),m,t;if(!i||!i.rendered)return TRUE;m=
