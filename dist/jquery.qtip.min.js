...
i.offset();break}n&&i.removeClass("ui-tooltip-accessible");return j}function o(){var d=e.elements;if(d.title){d.titlebar.remove();d.titlebar=d.title=d.button=NULL;d.tooltip.removeAttr("aria-labelledby")}}function v(){var d=e.elements,i=c.content.title.button;d.titlebar&&o();d.titlebar=a("<div />",{"class":"ui-tooltip-titlebar "+(c.style.widget?"ui-widget-header":"")}).append(d.title=a("<div />",{id:"ui-tooltip-"+k+"-title","class":"ui-tooltip-title",html:c.content.title.text})).prependTo(d.wrapper);
...
"fixed")a(document).bind("scroll"+t,m);/unfocus/i.test(c.hide.event)&&a(document).bind("mousedown"+t,function(y){var z=e.elements.tooltip;a(y.target).parents(".qtip.ui-tooltip").length===0&&a(y.target).add(b).length>1&&z.is(":visible")&&!z.hasClass("ui-state-disabled")&&e.hide()});c.position.target==="mouse"&&a(document).bind("mousemove"+t,function(y){c.position.adjust.mouse&&!r.tooltip.hasClass("ui-state-disabled")&&r.tooltip.is(":visible")&&e.reposition(y)})}}function u(d,i,n,j){j=parseInt(j,10)!==
...
e.reposition()},"^(show|hide).(event|target|fixed)":function(m,t,r,x){var s=d.search(/fixed/i)>-1?[0,[0,1,1,1]]:d.search(/hide/i)<0?["show",[1,0,0,0]]:["hide",[0,1,0,0]];if(s[0])m[t]=x;u.apply(e,s[1]);if(s[0])m[t]=r;w.apply(e,s[1])}}};a.each(e.plugins,function(m){if("object"===typeof this.checks)l[m]=this.checks});j=n[0][n[1]];n[0][n[1]]=i;K(c);for(f in l)for(g in l[f])RegExp(g,"i").test(d)&&l[f][g].call(e,n[0],n[1],i,j);return e},toggle:function(d,i){function n(){var t=d?"attr":"removeAttr",r=/^1|0$/.test(a(this).css("opacity"));
...
f.queue(function(){n.call(this);a(this).dequeue()})}else if(g.effect===FALSE){f[j]();n.call(f)}else f.fadeTo(90,d?100:0,n);d&&g.target.trigger("qtip-"+k+"-inactive");return e},show:function(d){e.toggle(TRUE,d)},hide:function(d){e.toggle(FALSE,d)},focus:function(d){if(!e.rendered)return FALSE;var i=e.elements.tooltip,n=parseInt(i.css("z-index"),10),j=a.fn.qtip.zindex+a(".qtip.ui-tooltip").length,f=a.extend({},d);if(!i.hasClass("ui-tooltip-focus")&&n!==j){a(".qtip.ui-tooltip").each(function(){var g=
a(this).qtip(),l=a.Event("tooltipblur"),m,t;if(!g||!g.rendered)return TRUE;m=g.elements.tooltip;t=parseInt(m.css("z-index"),10);isNaN(t)||m.css({zIndex:t-1});m.removeClass("ui-tooltip-focus");l.originalEvent=f;m.trigger(l,[g,j])});d=a.Event("tooltipfocus");d.originalEvent=f;i.trigger(d,[e.hash(),j]);d.isDefaultPrevented()||i.css({zIndex:j}).addClass("ui-tooltip-focus")}return e},reposition:function(d){if(e.rendered===FALSE)return FALSE;var i=c.position.target,n=e.elements.tooltip,j=c.position,f=j.my,
g=j.at,l=e.elements.tooltip.width(),m=e.elements.tooltip.height(),t=a(j.container)[0],r=0,x=0,s={left:0,top:0},y=a.Event("tooltipmove"),z={left:function(A){var C=i==="mouse"?d.pageX:i.offset().left,F=a(B).scrollLeft(),E=a(B).width(),H=g.x==="left"?r:g.x==="right"?-r:r/2,G=f.x!==g.x&&g.x!=="center"?r:0,L=H+(f.x==="left"?-l:f.x==="right"?l:l/2)+-2*j.adjust.x;E=A+l-E-F;if(F-A>0&&!(A>=C&&A<C+r))s.left+=L-H+G;else if(E>0&&A+l>C)s.left+=(f.x==="center"?-1:1)*(L-H-G);return s.left-A},top:function(A){var C=
a(B).scrollTop(),F=a(B).height(),E=g.y==="top"?x:g.y==="bottom"?-x:0,H=f.y!==g.y&&g.y!=="center"?x:0,G=E+(f.y==="top"?-m:f.y==="bottom"?m:-m/2)+-2*j.adjust.y;F=A+m-F-C;if(C-A>0)s.top+=f.y==="center"?-G+E:G;else if(F>0)s.top+=G-E-H;return s.top-A}};if(i==="mouse"){g={x:"left",y:"top"};if(!d)d=e.cache.event;s={top:d.pageY,left:d.pageX}}else{if(i==="event")i=d&&d.target&&d.type!=="scroll"&&d.type!=="resize"?e.cache.target=a(d.target):e.cache.target;if(i[0]===document||i[0]===B){r=i.width();x=i.height();
s={top:n.css("position")==="fixed"?0:i.scrollTop(),left:i.scrollLeft()}}else if(i.is("area")&&a.fn.qtip.plugins.imagemap){s=a.fn.qtip.plugins.imagemap(i,g);r=s.width;x=s.height;s=s.offset}else{r=i.outerWidth();x=i.outerHeight();s=i.offset();if(j.adjust.offset){do{s.left-=t.offsetLeft-t.scrollLeft;s.top-=t.offsetTop-t.scrollTop}while(t=t.offsetParent)}}s.left+=g.x==="right"?r:g.x==="center"?r/2:0;s.top+=g.y==="bottom"?x:g.y==="center"?x/2:0}s.left+=j.adjust.x+(f.x==="right"?-l:f.x==="center"?-l/2:
0);s.top+=j.adjust.y+(f.y==="bottom"?-m:f.y==="center"?-m/2:0);s.adjusted=j.adjust.screen&&i[0]!==B&&i[0]!==document.body?{left:z.left(s.left),top:z.top(s.top)}:{left:0,top:0};if(j.container[0]==document.body){if(s.top<1)s.top=0;if(s.left<1)s.left=0}n.attr("class",function(){return a(this).attr("class").replace(/ui-tooltip-pos-\w+/i,"")}).addClass("ui-tooltip-pos-"+f.abbreviation());y.originalEvent=a.extend({},d);n.trigger(y,[e.hash(),s]);if(y.isDefaultPrevented())return e;delete s.adjust;if(n.is(":visible")&&
a.isFunction(j.adjust.effect)){j.adjust.effect.call(n,s);n.queue(function(){a(this).css({opacity:"",height:""});a.browser.msie&&a(this).get(0).style&&a(this).get(0).style.removeAttribute("filter");a(this).dequeue()})}else n.css(s);return e},disable:function(d){var i=e.elements.tooltip;if(e.rendered)i.toggleClass("ui-state-disabled",d);else e.cache.disabled=!!d;return e},destroy:function(){var d=e.elements,i=d.target.data("oldtitle");e.rendered&&a.each(e.plugins,function(){this.initialize==="render"&&
this.destroy()});u(1,1,1,1);b.removeData("qtip");e.rendered&&d.tooltip.remove();i&&b.attr("title",i);return b},hash:function(){var d=a.extend({},e);delete d.cache;delete d.timers;delete d.options;delete d.plugins;delete d.render;delete d.hash;return d}})}function N(b,c){var k;k=a(this).metadata?a(this).metadata(c.metadata):{};k=a.extend(TRUE,{},c,k);var h=k.position,q=a(this)[0]===document?a(document.body):a(this);if("boolean"===typeof k.content.text)if(k.content.attr!==FALSE&&a(this).attr(k.content.attr))k.content.text=
a(this).attr(k.content.attr);else return FALSE;if(h.container===FALSE)h.container=a(document.body);if(h.target===FALSE)h.target=q;if(k.show.target===FALSE)k.show.target=q;if(k.hide.target===FALSE)k.hide.target=q;h.at=new a.fn.qtip.plugins.Corner(h.at);h.my=new a.fn.qtip.plugins.Corner(h.my);if(a(this).data("qtip"))if(k.overwrite)a(this).qtip("destroy");else if(k.overwrite===FALSE)return FALSE;k=new M(a(this),k,b);a(this).data("qtip",k);return k}function O(b){var c=this;c.checks={"^content.ajax":function(){this.plugins.ajax.load(this.options.content.ajax)}};
a.extend(c,{init:function(){var k=b.options.content.ajax;c.load(k);b.elements.tooltip.bind("tooltipshow.ajax",function(){k.once===FALSE&&b.rendered===TRUE&&c.load(k)})},load:function(k){a.ajax(a.extend(TRUE,{},k,{success:function(h,q){if(a.isFunction(k.success))if(k.success.call(b.hash(),h,q)===FALSE)return;b.set("content.text",h);I.remove()},error:function(h,q,o){var v=q||o;if(a.isFunction(k.error)){h=k.error.call(b.hash(),h,q,o);if(h===FALSE)return}b.set("content.text",v)}}));return c},destroy:function(){b.elements.tooltip.unbind("tooltipshow.ajax")}});
...
top:0,bottom:0},m=0;if(q.corner===FALSE||!f)return FALSE;j=j||h.corner;f.css({top:"",bottom:"",left:"",right:"",margin:""});g[j.precedance==="y"?"push":"unshift"]("top","bottom");if(a.browser.msie)l={top:j.precedance==="y"?0:0,left:0,bottom:j.precedance==="y"?0:0,right:0};switch(j[j.precedance==="y"?"x":"y"]){case "center":f.css(g[0],"50%").css("margin-"+g[0],-(u[j.precedance==="y"?"width":"height"]/2));break;case g[0]:f.css(g[0],l[g[0]]+i);break;case g[1]:f.css(g[1],l[g[1]]+i);break}m=u[j.precedance===
...
if(m.top)this.y=this.y==="center"?m.top>0?"top":"bottom":this.y==="top"?"bottom":"top"});g[l[1]]+=(j[l[0]]===l[1]?1:-1)*(u[l[3]]-t);g[l[2]]-=i;if(j.string()!==w.corner.string()&&(w.top!==m.top||w.left!==m.left))h.update(j,f);w.left=m.left;w.top=m.top;w.corner=j}}var h=this,q=b.options.style.tip,o=b.elements,v=o.tooltip,p=o.wrapper,w={top:0,left:0,corner:{string:function(){}}},u={width:q.width,height:q.height},e={},d=q.border||0,i=q.adjust||0,n=q.method||FALSE;h.corner=NULL;h.mimic=NULL;h.checks={"^position.my|style.tip.(corner|mimic|method|border)":function(){d=
q.border;if(h.detectCorner()){h.create();h.detectColours();h.update()}else h.tip.remove();this.get("position.target")!=="mouse"&&this.reposition()},"^style.tip.(height|width)":function(){u={width:q.width,height:q.height};h.create();h.update();b.reposition()}};a.extend(h,{init:function(){if(n===TRUE)n=a("<canvas />")[0].getContext?"canvas":a.browser.msie&&(h.mimic&&/center/i.test(h.mimic.string())||u.height!==u.width)?"vml":"polygon";else if(n==="canvas")n=a.browser.msie?"vml":!a("<canvas />")[0].getContext?
"polygon":"canvas";else if(n==="polygon")n=a.browser.msie&&/center/i.test(h.mimic.string())?"vml":n;if(h.detectCorner()){h.create();h.detectColours();h.update();v.bind("tooltipmove.tip",k)}return h},detectCorner:function(){var j=q.corner,f=q.mimic||j,g=b.options.position.at,l=b.options.position.my;if(l.string)l=l.string();if(j===FALSE||l===FALSE&&g===FALSE)return FALSE;else{if(j===TRUE)h.corner=new a.fn.qtip.plugins.Corner(l);else if(!j.string)h.corner=new a.fn.qtip.plugins.Corner(j);if(f===TRUE)h.mimic=
...
2)+"px solid "+A)});break}c(j);return h},destroy:function(){o.tip&&o.tip.remove();v.unbind("tooltipmove.tip")}})}function Q(b,c){var k=this,h=b.elements,q=h.tooltip;h.blanket=a("#qtip-blanket");a.extend(k,{init:function(){c=a.extend(TRUE,a.fn.qtip.plugins.modal.defaults,c);q.bind("tooltipshow.qtipmodal tooltiphide.qtipmodal",function(o,v,p){o=o.type.replace("tooltip","");a.isFunction(c[o])?c[o].call(h.blanket,p,v):k[o](p)});h.blanket.length||k.create();c.blur===TRUE&&h.blanket.bind("click.qtipmodal"+
b.id,function(){b.hide.call(b)})},create:function(){h.blanket=a("<div />",{id:"qtip-blanket",css:{position:"absolute",top:0,left:0,display:"none"}}).appendTo(document.body);a(B).bind("resize.qtipmodal",function(){h.blanket.css({height:Math.max(a(B).height(),a(document).height()),width:Math.max(a(B).width(),a(document).width())})}).trigger("resize")},toggle:function(o){var v=h.blanket,p=b.options.show.modal.effect,w=o?"show":"hide";if(a.isFunction(p))p.call(h.blanket);else p===FALSE?v[w]():v.fadeTo(90,
o?100:0)},show:function(){k.toggle(true)},hide:function(){k.toggle(false)},destroy:function(){var o=TRUE;a("*").each(function(){var v=a(this).data("qtip");if(v&&v.id!==b.id&&v.options.show.modal)return o=FALSE});if(o){h.blanket.remove();a(B).unbind("scroll.qtipmodal resize.qtipmodal")}else h.blanket.unbind("click.qtipmodal"+b.id);q.unbind("tooltipshow.qtipmodal tooltiphide.qtipmodal")}});k.init()}function R(b){var c=this,k=b.elements,h=k.tooltip,q=".bgiframe-"+b.id,o="tooltipmove"+q+" tooltipshow"+
q;a.extend(c,{init:function(){k.bgiframe=a('<iframe class="ui-tooltip-bgiframe" frameborder="0" tabindex="-1" src="javascript:\'\';"  style="display:block; position:absolute; z-index:-1; filter:alpha(opacity=0);"></iframe>');k.bgiframe.appendTo(h);h.bind(o,c.adjust)},adjust:function(){var v=b.calculate("dimensions"),p=b.plugins.tip,w=b.elements.tip,u;u=parseInt(h.css("border-left-width"),10);u={left:-u,top:-u};if(p&&w){p=p.corner.precedance==="x"?["width","left"]:["height","top"];u[p[1]]-=w[p[0]]()}k.bgiframe.css(u).css(v)},
destroy:function(){c.iframe.remove();h.unbind(o)}});c.init()}a.fn.qtip=function(b,c,k){var h=String(b).toLowerCase(),q=FALSE,o=h==="disable"?[TRUE]:a.makeArray(arguments).splice(1),v=o[o.length-1],p;if(!b&&a(this).data("qtip")||h==="api")return(p=a(this).eq(0).data("qtip"))?p.hash():D;else if("string"===typeof b){a(this).each(function(){var w=a(this).data("qtip");if(!w)return TRUE;if(/option|set/.test(h)&&c)if(k!==D)w.set(c,k);else q=w.get(c);else{if(!w.rendered&&(h==="show"||h==="toggle")){if(v.timeStamp)w.cache.event=
v;w.render()}else if(h==="enable"){h="disable";o=[FALSE]}w[h]&&w[h].apply(w[h],o)}});return q!==FALSE?q:a(this)}else if("object"===typeof b){K(b);p=a.extend(TRUE,{},a.fn.qtip.defaults,b);return a.fn.qtip.bind.call(this,p)}};a.fn.qtip.bind=function(b){return a(this).each(function(){function c(w){function u(){h.render(typeof w==="object"||q.show.ready);o.show.unbind(v.show);o.hide.unbind(v.hide)}if(h.cache.disabled)return FALSE;h.cache.event=a.extend({},w);if(q.show.delay>0){h.timers.show=setTimeout(u,
q.show.delay);v.show!==v.hide&&o.hide.bind(v.hide,function(){clearTimeout(h.timers.show)})}else u()}var k,h,q,o,v,p;k=b.id===FALSE||b.id.length<1||a("#ui-tooltip-"+b.id).length?a.fn.qtip.nextid++:b.id;p=".qtip-"+k+"-create";h=N.call(a(this),k,b);if(h===FALSE)return TRUE;q=h.options;a(this).attr("title")&&a(this).data("oldtitle",a(this).attr("title")).removeAttr("title");a.each(a.fn.qtip.plugins,function(){this.initialize==="initialize"&&this(h)});o={show:q.show.target,hide:q.hide.target};v={show:String(q.show.event).replace(" ",
p+" ")+p,hide:String(q.hide.event).replace(" ",p+" ")+p};q.show.ready||q.prerender||q.show.event===FALSE?c():o.show.bind(v.show,c)})};a.each({attr:function(b){var c=a(this).data("qtip");return arguments.length===1&&b==="title"&&c&&c.rendered===TRUE?a(this).data("oldtitle"):NULL},remove:a.ui?NULL:function(b,c){this.each(function(){if(!c)if(!b||a.filter(b,[this]).length)a("*",this).add(this).each(function(){a(this).triggerHandler("remove")})})}},function(b,c){if(!c)return TRUE;var k=a.fn[b];a.fn[b]=
function(){return c.apply(this,arguments)||k.apply(this,arguments)}});a.fn.qtip.nextid=0;a.fn.qtip.inactiveEvents="click dblclick mousedown mouseup mousemove mouseleave mouseenter".split(" ");a.fn.qtip.zindex=15E3;a.fn.qtip.plugins={Corner:function(b){this.x=(String(b).replace(/middle/i,"center").match(/left|right|center/i)||["false"])[0].toLowerCase();this.y=(String(b).replace(/middle/i,"center").match(/top|bottom|center/i)||["false"])[0].toLowerCase();this.precedance=b.charAt(0).search(/^(t|b)/)>
...
offset:FALSE}},show:{target:FALSE,event:"mouseenter",effect:TRUE,delay:90,solo:FALSE,ready:FALSE},hide:{target:FALSE,event:"mouseleave",effect:TRUE,delay:0,fixed:FALSE,inactive:FALSE},style:{classes:"",widget:FALSE},events:{render:a.noop,move:a.noop,show:a.noop,hide:a.noop,focus:a.noop,blur:a.noop}};var I=a();a.fn.qtip.plugins.ajax=function(b){var c=b.plugins.ajax,k=b.options.content;if(k.ajax&&k.ajax.url)if(c)return c;else{b.plugins.ajax=new O(b);return b.plugins.ajax}};a.fn.qtip.plugins.ajax.initialize=
"render";a.fn.qtip.plugins.ajax.sanitize=function(b){if(b.content!==D)if(b.content.ajax!==D){if(typeof b.content.ajax!=="object")b.content.ajax={url:b.content.ajax};if(b.content.text===FALSE)b.content.text="Loading...";b.content.ajax.once=Boolean(b.content.ajax.once);b.content.ajax.preload=Boolean(b.content.ajax.preload);if(b.content.ajax.preload){b=b.content.ajax.url;a("#qtip-preload").length||a('<div id="qtip-preload" class="ui-tooltip-accessible" />').appendTo(document.body);I.length||(I=a("<div />").appendTo("#qtip-preload").load(b+
" img"))}}};a.fn.qtip.plugins.tip=function(b){var c=b.plugins.tip,k=b.options.style.tip;if(k&&k.corner)if(c)return c;else{b.plugins.tip=new P(b);b.plugins.tip.init();return b.plugins.tip}};a.fn.qtip.plugins.tip.initialize="render";a.fn.qtip.plugins.tip.sanitize=function(b){if(b.style!==D&&b.style.tip!==D){if(typeof b.style.tip!=="object")b.style.tip={corner:b.style.tip};if(typeof b.style.tip.method!=="string")b.style.tip.method=TRUE;if(!/canvas|polygon/i.test(b.style.tip.method))b.style.tip.method=
...
2);for(i=d.length;i--;){if(d.length<2)break;f=d[i][0]-e.offset.left;g=d[i][1]-e.offset.top;if(c.x==="left"&&f>=n||c.x==="right"&&f<=n||c.x==="center"&&(f<n||f>e.width-n)||c.y==="top"&&g>=j||c.y==="bottom"&&g<=j||c.y==="center"&&(g<j||g>e.height-j))d.splice(i,1)}}return{left:d[0][0],top:d[0][1]}}var h=b.attr("shape").toLowerCase(),q=b.attr("coords").split(","),o=[],v=a('img[usemap="#'+b.parent("map").attr("name")+'"]').offset(),p={width:0,height:0,offset:{top:1E10,right:0,bottom:0,left:1E10}},w=0,
u=0;if(h==="poly")for(w=q.length;w--;){u=[parseInt(q[--w],10),parseInt(q[w+1],10)];if(u[0]>p.offset.right)p.offset.right=u[0];if(u[0]<p.offset.left)p.offset.left=u[0];if(u[1]>p.offset.bottom)p.offset.bottom=u[1];if(u[1]<p.offset.top)p.offset.top=u[1];o.push(u)}else o=a.map(q,function(e){return parseInt(e,10)});switch(h){case "rect":p={width:Math.abs(o[2]-o[0]),height:Math.abs(o[3]-o[1]),offset:{left:o[0],top:o[1]}};break;case "circle":p={width:o[2]+2,height:o[2]+2,offset:{left:o[0],top:o[1]}};break;
case "poly":a.extend(p,{width:Math.abs(p.offset.right-p.offset.left),height:Math.abs(p.offset.bottom-p.offset.top)});p.offset=c.string()==="centercenter"?{left:p.offset.left+p.width/2,top:p.offset.top+p.height/2}:k(p,o.slice());p.width=p.height=0;break}p.offset.left+=v.left;p.offset.top+=v.top;return p};a.fn.qtip.plugins.modal=function(b){var c=b.plugins.modal,k=b.options.show.modal;if(c)return c;else if(typeof k==="object"){b.plugins.modal=new Q(b,k);return b.plugins.modal}};a.fn.qtip.plugins.modal.initialize=
"render";a.fn.qtip.plugins.modal.sanitize=function(b){if(b.show&&b.show.modal!==D)if(typeof b.show.modal!=="object")b.show.modal={}};a.fn.qtip.plugins.modal.defaults={effect:TRUE,blur:TRUE};a.fn.qtip.plugins.bgiframe=function(b){if(!(a.browser.msie&&/^6\.[0-9]/.test(a.browser.version)&&a("select, object").length))return FALSE;var c=b.plugins.bgiframe;if(c)return c;else{b.plugins.bgiframe=new R(b);return b.plugins.bgiframe}};a.fn.qtip.plugins.bgiframe.initialize="render"})(jQuery,window);
