...
g.type==="mouseenter")}).click(function(g){c.tooltip.hasClass(M)||b.hide(g);return l}).bind("mousedown keydown mouseup keyup mouseout",function(g){d(this).toggleClass("ui-state-active ui-state-focus",/down$/i.test(g.type))});b.redraw()}function y(){var c=b.elements,f=H+"-"+b.id+"-title";c.titlebar&&s();c.titlebar=d("<div />",{"class":H+"-titlebar "+(a.style.widget?"ui-widget-header":"")}).append(c.title=d("<div />",{id:f,"class":H+"-title",html:a.content.title.text})).insertBefore(c.content);c.tooltip.attr("aria-labelledby",
