...
this(e)});e.rendered=TRUE;B(1,1,1,1);a.each(b.events,function(l,g){g&&f.tooltip.bind("tooltip"+l,g)});f.tooltip.queue("fx",function(l){if(b.show.ready||d){f.tooltip.hide();e.show(e.cache.event)}f.tooltip.removeClass("ui-tooltip-accessible");i.originalEvent=e.cache.event;f.tooltip.trigger(i,[e]);l()});return e},get:function(d){switch(d.toLowerCase()){case "offset":d=m("position");break;case "dimensions":d=m("dimensions");break;default:d=h(d.toLowerCase());d=d[0].precedance?d[0].string():d[0].jquery?
...
d);i.trigger(I,[e,y,w.elem]);if(I.isDefaultPrevented())return e;delete y.adjusted;if(i.is(":visible")&&a.isFunction(l.effect)){l.effect.call(i,e,y);i.queue(function(){var G=a(this);G.css({opacity:"",height:""});a.browser.msie&&this.style&&this.style.removeAttribute("filter");G.dequeue()})}else isNaN(y.left,y.top)||i.css(y);return e},redraw:function(){if(!e.rendered||!(a.browser.msie&&parseInt(a.browser.version.charAt(0),10)<9))return FALSE;var d=e.elements.tooltip;d.attr("style");var f;d.css({width:"auto",
height:"auto"});f=m("dimensions",1);a.each(["width","height"],function(i,l){var g=parseInt(d.css("max-"+l),10)||0,q=parseInt(d.css("min-"+l),10)||0;f[l]=g+q?Math.min(Math.max(f[l],q),g):f[l]});d.css(f)},disable:function(d){var f=e.elements.tooltip;if(e.rendered)f.toggleClass("ui-state-disabled",d);else e.cache.disabled=!!d;return e},destroy:function(){var d=e.elements,f=d.target.data("oldtitle");e.rendered&&a.each(e.plugins,function(){this.initialize==="render"&&this.destroy()});z(1,1,1,1);c.removeData("qtip");
e.rendered&&d.tooltip.remove();f&&c.attr("title",f);c.removeAttr("aria-describedby");return c}})}function Q(c,b){var k,h,p=a(this);k=a(document.body);var m=this===document?k:p;h=p.metadata?p.metadata(b.metadata):NULL;var s=a.extend(TRUE,{},a.fn.qtip.defaults,b,M((h&&b.metadata.type==="html5"?h[b.metadata.name]:NULL)||h));p.removeData("metadata");h=s.position;if("boolean"===typeof s.content.text)if(s.content.attr!==FALSE&&p.attr(s.content.attr))s.content.text=p.attr(s.content.attr);else return FALSE;
if(h.container===FALSE)h.container=k;if(h.target===FALSE)h.target=m;if(s.show.target===FALSE)s.show.target=m;if(s.hide.target===FALSE)s.hide.target=m;h.at=new a.fn.qtip.plugins.Corner(h.at);h.my=new a.fn.qtip.plugins.Corner(h.my);if(p.data("qtip"))if(s.overwrite)p.qtip("destroy");else if(s.overwrite===FALSE)return FALSE;p.attr("title")&&p.data("oldtitle",p.attr("title")).removeAttr("title");k=new P(p,s,c);p.data("qtip",k);return k}function R(c){var b=this;b.checks={"^content.ajax":function(){this.plugins.ajax.load(this.options.content.ajax)}};
a.extend(b,{init:function(){var k=c.options.content.ajax;c.elements.tooltip.bind("tooltiprender.ajax",function(){b.load(k);c.elements.tooltip.bind("tooltipshow.ajax",function(){k.once===FALSE&&c.rendered===TRUE&&b.load(k)})})},load:function(k){a.ajax(a.extend(TRUE,{},k,{success:function(h,p){if(a.isFunction(k.success))if(k.success.call(c.hash(),h,p)===FALSE)return;c.set("content.text",h)},error:function(h,p,m){var s=p||m;if(a.isFunction(k.error)){h=k.error.call(c.hash(),h,p,m);if(h===FALSE)return}c.set("content.text",
s)}}));return b},destroy:function(){c.elements.tooltip.unbind("tooltipshow.ajax")}});b.init()}function O(c,b,k){var h=Math.floor(b/2),p=Math.floor(k/2);b={bottomright:[[0,0],[b,k],[b,0]],bottomleft:[[0,0],[b,0],[0,k]],topright:[[0,k],[b,0],[b,k]],topleft:[[0,0],[0,k],[b,k]],topcenter:[[0,k],[h,0],[b,k]],bottomcenter:[[0,0],[b,0],[h,k]],rightcenter:[[0,0],[b,p],[0,k]],leftcenter:[[b,0],[b,k],[0,p]]};b.lefttop=b.bottomright;b.righttop=b.bottomleft;b.leftbottom=b.topright;b.rightbottom=b.topleft;return b[c]}
function S(c){function b(j){var n=m.tip,d=["left","right"],f=p.offset,i,l;if(p.corner===FALSE||!n)return FALSE;j=j||h.corner;i=j.precedance;l=i==="y"?"x":"y";d[i==="y"?"push":"unshift"]("top","bottom");f=Math.max(j[l]==="center"?f:0,f);n.css({top:"",bottom:"",left:"",right:"",margin:""});switch(j[i==="y"?"x":"y"]){case "center":n.css(d[0],"50%").css("margin-"+d[0],-Math.floor(A[i==="y"?"width":"height"]/2)+f);break;case d[0]:n.css(d[0],f);break;case d[1]:n.css(d[1],f);break}f=A[i==="x"?"width":"height"];
if(z){s.toggleClass("ui-tooltip-accessible",!s.is(":visible"));f-=parseInt(v.css("border-"+j[i]+"-width"),10)||0;s.removeClass("ui-tooltip-accessible")}if(e==="vml"&&/bottom|right/.test(j[j.precedance]))f+=z?1:-1;n.css(j[i],-f)}function k(j,n,d){if(m.tip){j=a.extend({},h.corner);n=j.precedance==="y"?["y","top","left","height","x"]:["x","left","top","width","y"];var f=d.adjusted,i=[0,0];if(h.corner.fixed!==TRUE){if(f.left)j.x=j.x==="center"?f.left>0?"left":"right":j.x==="left"?"right":"left";if(f.top)j.y=
j.y==="center"?f.top>0?"top":"bottom":j.y==="top"?"bottom":"top";if(j.string()!==o.corner.string()&&(o.top!==f.top||o.left!==f.left))h.update(j)}i[0]=z?parseInt(v.css("border-"+j[n[0]]+"-width"),10)||0:e==="vml"?1:0;i[1]=Math.max(j[n[4]]==="center"?p.offset:0,p.offset);d[n[1]]+=(j[n[0]]===n[1]?1:-1)*(A[n[3]]-i[0]);d[n[2]]-=(j[n[4]]===n[2]||j[n[4]]==="center"?1:-1)*i[1];o.left=f.left;o.top=f.top;o.corner=j}}var h=this,p=c.options.style.tip,m=c.elements,s=m.tooltip,v=m.wrapper,o={top:0,left:0,corner:{string:function(){}}},
A={width:p.width,height:p.height},B={},z=p.border||0,e=p.method||FALSE;h.corner=NULL;h.mimic=NULL;h.checks={"^position.my|style.tip.(corner|mimic|method|border)":function(){z=p.border;if(h.init())this.get("position.target")!=="mouse"&&this.reposition();else h.destroy()},"^style.tip.(height|width)":function(){A={width:p.width,height:p.height};h.create();h.update();c.reposition()},"^style.(classes|widget)$":function(){h.detectColours();h.update()}};a.extend(h,{init:function(){var j=a.browser.msie,n=
h.detectCorner(),d=h[h.mimic?"mimic":"corner"].string().indexOf("center")>-1;if(n){if(e===TRUE)e=a("<canvas />")[0].getContext?"canvas":j&&(d||A.height!==A.width)?"vml":"polygon";else if(e==="canvas")e=j?"vml":!a("<canvas />")[0].getContext?"polygon":"canvas";else if(e==="polygon")e=j&&d?"vml":e;h.create();h.detectColours();h.update();s.unbind(".qtip-tip").bind("tooltipmove.qtip-tip",k)}return n},detectCorner:function(){var j=p.corner,n=c.options.position.at,d=c.options.position.my;if(d.string)d=
d.string();if(j===FALSE||d===FALSE&&n===FALSE)return FALSE;else if(j===TRUE)h.corner=new a.fn.qtip.plugins.Corner(d);else if(!j.string){h.corner=new a.fn.qtip.plugins.Corner(j);h.corner.fixed=TRUE}return h.corner.string()!=="centercenter"},detectColours:function(){var j=m.tip,n=h.corner,d=h.corner[h.corner.precedance],f="border-"+d+"-color",i=/rgba?\(0, 0, 0(, 0)?\)|transparent/i,l=m.titlebar&&n.y==="top",g=c.options.style.widget;n=g?m.content:l?m.titlebar:m.wrapper;l=!g?m.wrapper:l?m.titlebar:m.content;
B.fill=j.css({backgroundColor:"",border:""}).css("background-color")||"transparent";B.border=j.get(0).style?j.get(0).style["border"+d.charAt(0)+d.substr(1)+"Color"]:j.css(f)||"transparent";if(i.test(B.fill))B.fill=z?n.css("background-color"):l.css(f);if(!B.border||i.test(B.border))B.border=l.css(f)||B.fill;a("*",j).add(j).css("background-color","transparent").css("border",0)},create:function(){var j=A.width,n=A.height;m.tip&&m.tip.remove();m.tip=a('<div class="ui-tooltip-tip" />').toggleClass("ui-widget-content",
c.options.style.widget).css(A).prependTo(s);switch(e){case "canvas":a('<canvas height="'+n+'" width="'+j+'" />').appendTo(m.tip)[0].getContext("2d").save();break;case "vml":m.tip.html('<vml:shape coordorigin="0 0" coordsize="'+j+" "+n+'" stroked="'+!!z+'"  style="behavior:url(#default#VML); display:inline-block; antialias:TRUE; position: absolute;  top:0; left:0; width:'+j+"px; height:"+n+"px; vertical-align:"+h.corner.y+';"><vml:stroke weight="'+(z-2)+'px" joinstyle="miter" miterlimit="10"  style="behavior:url(#default#VML); display:inline-block;" /></vml:shape>');
break;case "polygon":m.tip.append('<div class="ui-tooltip-tip-inner" />').append(z?'<div class="ui-tooltip-tip-border" />':"");break}return h},update:function(j){var n=m.tip,d=A.width,f=A.height,i=z>0?0:1,l=Math.ceil(z/2+0.5),g=p.mimic,q,x;if(!j)j=h.corner;if(g===FALSE)g=j;else{g=new a.fn.qtip.plugins.Corner(g);g.precedance=j.precedance;if(g.x==="inherit")g.x=j.x;else if(g.y==="inherit")g.y=j.y;else if(g.x===g.y)g[j.precedance]=j[j.precedance]}x=Math[/b|r/.test(g[g.precedance==="y"?"x":"y"])?"ceil":
"floor"];n=n.children();switch(e){case "canvas":n=n.get(0).getContext("2d");n.restore&&n.restore();n.clearRect(0,0,3E3,3E3);for(q=O(g.string(),d,f);i<2;i++){if(i){n.save();n.translate(x((g.x==="left"?1:g.x==="right"?-1:0)*(z+1)*(g.precedance==="y"?0.5:1)),x((g.y==="top"?1:g.y==="bottom"?-1:0)*(z+1)*(g.precedance==="x"?0.5:1)))}n.beginPath();n.moveTo(q[0][0],q[0][1]);n.lineTo(q[1][0],q[1][1]);n.lineTo(q[2][0],q[2][1]);n.closePath();n.fillStyle=B[i?"fill":"border"];n.fill()}break;case "vml":q=O(g.string(),
d,f);i="m"+q[0][0]+","+q[0][1]+" l"+q[1][0]+","+q[1][1]+" "+q[2][0]+","+q[2][1]+" xe";n.attr({path:i,fillcolor:B.fill});if(z){n.children().attr("color",B.border);if(g.precedance==="y"){n.css("top",(g.y==="top"?1:-1)*(z-2));n.css("left",g.x==="left"?1:-2)}else{n.css("left",(g.x==="left"?1:-1)*(z-2));n.css("top",g.y==="top"?1:-2)}}break;case "polygon":if(g.precedance==="y"){i=d>f?1.5:d<f?5:2.2;l=[g.x==="left"?l:g.x==="right"?-l:0,Math.floor(i*l*(g.y==="bottom"?-1:1)*(g.x==="center"?0.8:1))]}else{i=
d<f?1.5:d>f?5:2.2;l=[Math.floor(i*l*(g.x==="right"?-1:1)*(g.y==="center"?0.9:1)),g.y==="top"?l:g.y==="bottom"?-l:0]}n.removeAttr("style").each(function(D){var u={x:g.precedance==="x"?g.x==="left"?"right":"left":g.x,y:g.precedance==="y"?g.y==="top"?"bottom":"top":g.y},t=g.x==="center"?["left","right",u.y,f,d]:["top","bottom",u.x,d,f],r=B[!D&&z?"border":"fill"];D&&a(this).css({position:"absolute","z-index":1,left:l[0],top:l[1]});g.x==="center"||g.y==="center"?a(this).css("border-"+t[2],t[3]+"px solid "+
r).css("border-"+t[0],Math.floor(t[4]/2)+"px dashed transparent").css("border-"+t[1],Math.floor(t[4]/2)+"px dashed transparent"):a(this).css("border-width",Math.floor(f/2)+"px "+Math.floor(d/2)+"px").css("border-"+u.x,Math.floor(d/2)+"px solid "+r).css("border-"+u.y,Math.floor(f/2)+"px solid "+r)});break}b(j);return h},destroy:function(){m.tip&&m.tip.remove();s.unbind(".qtip-tip")}})}function T(c,b){var k=this,h=c.elements,p=h.tooltip;h.overlay=a("#qtip-overlay");a.extend(k,{init:function(){p.bind("tooltipshow.qtipmodal tooltiphide.qtipmodal",
function(m,s,v){m=m.type.replace("tooltip","");a.isFunction(b[m])?b[m].call(h.overlay,v,s):k[m](v)});h.overlay.length||k.create();b.blur===TRUE&&h.overlay.bind("click.qtipmodal"+c.id,function(){c.hide.call(c)})},create:function(){h.overlay=a("<div />",{id:"qtip-overlay",css:{position:"absolute",top:0,left:0,display:"none"}}).appendTo(document.body);a(F).bind("resize.qtipmodal",function(){h.overlay.css({height:Math.max(a(F).height(),a(document).height()),width:Math.max(a(F).width(),a(document).width())})}).trigger("resize")},
toggle:function(m){var s=h.overlay,v=c.options.show.modal.effect,o=m?"show":"hide";s.stop(TRUE,FALSE);if(a.isFunction(v))v.call(s,m);else v===FALSE?s[o]():s.fadeTo(90,m?0.7:0,function(){m||a(this).hide()})},show:function(){k.toggle(TRUE)},hide:function(){k.toggle(FALSE)},destroy:function(){var m=TRUE;a("*").each(function(){var s=a(this).data("qtip");if(s&&s.id!==c.id&&s.options.show.modal)return m=FALSE});if(m){h.overlay.remove();a(F).unbind("scroll.qtipmodal resize.qtipmodal")}else h.overlay.unbind("click.qtipmodal"+
c.id);p.unbind("tooltipshow.qtipmodal tooltiphide.qtipmodal")}});k.init()}function U(c){var b=this,k=c.elements,h=k.tooltip,p=".bgiframe-"+c.id,m="tooltipmove"+p+" tooltipshow"+p;a.extend(b,{init:function(){k.bgiframe=a('<iframe class="ui-tooltip-bgiframe" frameborder="0" tabindex="-1" src="javascript:\'\';"  style="display:block; position:absolute; z-index:-1; filter:alpha(opacity=0);"></iframe>');k.bgiframe.appendTo(h);h.bind(m,b.adjust)},adjust:function(){var s=c.get("dimensions"),v=c.plugins.tip,
o=c.elements.tip,A;A=parseInt(h.css("border-left-width"),10)||0;A={left:-A,top:-A};if(v&&o){v=v.corner.precedance==="x"?["width","left"]:["height","top"];A[v[1]]-=o[v[0]]()}k.bgiframe.css(A).css(s)},destroy:function(){b.iframe.remove();h.unbind(m)}});b.init()}a.fn.qtip=function(c,b,k){var h=String(c).toLowerCase(),p=NULL,m=h==="disable"?[TRUE]:a.makeArray(arguments).slice(1,10),s=m[m.length-1],v;if(!arguments.length&&this.data("qtip")||h==="api")return(v=this.data("qtip"))?v:L;else if("string"===
typeof c){this.each(function(){var o=a(this).data("qtip");if(!o)return TRUE;if(/option|set/.test(h)&&b)if(k!==L)o.set(b,k);else p=o.get(b);else{if(!o.rendered&&(h==="show"||h==="toggle")){if(s&&s.timeStamp)o.cache.event=s;o.render(1)}else if(h==="enable"){h="disable";m=[FALSE]}o[h]&&o[h].apply(o[h],m)}});return p!==NULL?p:this}else if("object"===typeof c||!arguments.length){v=M(a.extend(TRUE,{},c));return a.fn.qtip.bind.call(this,v,s)}};a.fn.qtip.bind=function(c,b){return this.each(function(){function k(A){function B(){o.render(typeof A===
"object"||h.show.ready);p.show.unbind(m.show);p.hide.unbind(m.hide)}if(o.cache.disabled)return FALSE;o.cache.event=a.extend({},A);if(h.show.delay>0){clearTimeout(o.timers.show);o.timers.show=setTimeout(B,h.show.delay);m.show!==m.hide&&p.hide.bind(m.hide,function(){clearTimeout(o.timers.show)})}else B()}var h,p,m,s=c.id=!c.id||c.id===FALSE||c.id.length<1||a("#ui-tooltip-"+c.id).length?a.fn.qtip.nextid++:c.id,v=".qtip-"+s+"-create",o=Q.call(this,s,c);if(o===FALSE)return TRUE;h=o.options;a.each(a.fn.qtip.plugins,
function(){this.initialize==="initialize"&&this(o)});p={show:h.show.target,hide:h.hide.target};m={show:String(h.show.event).replace(" ",v+" ")+v,hide:String(h.hide.event).replace(" ",v+" ")+v};p.show.bind(m.show,k);if(h.show.ready||h.prerender)k(b)})};a.each({attr:function(c){var b=a(this),k=b.data("qtip");return arguments.length===1&&c==="title"&&k&&k.rendered===TRUE?b.data("oldtitle"):NULL},remove:a.ui?NULL:function(c,b){a(this).each(function(){if(!b)if(!c||a.filter(c,[this]).length)a("*",this).add(this).each(function(){a(this).triggerHandler("remove")})})}},
