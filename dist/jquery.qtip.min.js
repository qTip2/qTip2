...
"number"&&delete b.width;typeof b.height!=="number"&&delete b.height;typeof b.border!=="number"&&b.border!==w&&delete b.border;typeof b.offset!=="number"&&delete b.offset}};a.extend(w,a.fn.qtip.defaults,{style:{tip:{corner:w,mimic:n,width:8,height:8,border:w,offset:0}}});a.fn.qtip.plugins.imagemap=function(e,b){function m(z,N){for(var h=0,o=1,c=1,v=0,B=0,g=z.width,d=z.height;g>0&&d>0&&o>0&&c>0;){g=Math.floor(g/2);d=Math.floor(d/2);if(b.x==="left")o=g;else if(b.x==="right")o=z.width-g;else o+=Math.floor(g/
