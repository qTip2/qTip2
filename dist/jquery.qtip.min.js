...
g)}return i}function m(d,f){var i=e.elements.tooltip,l=j+"-accessible "+(f?j+"-accessible-fluid":""),g=!i.is(":visible"),r=FALSE;if(!e.rendered)return FALSE;g&&i.addClass(l);switch(d){case "dimensions":r={height:i.outerHeight(),width:i.outerWidth()};break;case "position":r=p(i[0],b.position.container);break}g&&i.removeClass(l);return r}function s(){var d=e.elements;if(d.title){d.titlebar.remove();d.titlebar=d.title=d.button=NULL;d.tooltip.removeAttr("aria-labelledby")}}function v(){var d=e.elements,
...
q,E,I){var y=d.search(/fixed/i)>-1?[0,[0,1,1,1]]:[d.substr(0,3),d.charAt(0)==="s"?[1,0,0,0]:[0,1,0,0]];if(y[0])t[q]=I;A.apply(e,y[1]);if(y[0])t[q]=E;C.apply(e,y[1])},"^show.ready$":function(){e.rendered===FALSE&&e.show()},"^style.classes$":function(){e.elements.tooltip.attr("class",j+" qtip ui-helper-reset "+f)},"^style.widget$":function(){var t=!!f;g.toggleClass("ui-widget",t);l.titlebar.toggleClass("ui-widget-header",t);l.content.toggleClass("ui-widget-content",t);l.button.children("span").toggleClass(j+
"-icon",!t).toggleClass("ui-icon",t)},"^events.(render|show|move|hide|focus|blur)":function(t,q,E){l.tooltip[(a.isFunction(f)?"":"un")+"bind"]("tooltip"+q,E)}}};a.each(e.plugins,function(t){if("object"===typeof this.checks)u[t]=this.checks});r=i[0][i[1]];i[0][i[1]]=f.nodeType?a(f):f;M(b);for(z in u)for(D in u[z])RegExp(D,"i").test(d)&&u[z][D].call(e,i[0],i[1],f,r);return e},toggle:function(d,f){function i(){var D=a(this),u=d?"attr":"removeAttr",t=/^1|0$/.test(D.css("opacity")),q=this.style;e.elements.title&&
c[u]("aria-labelledby",j+"-"+k+"-title");c[u]("aria-describedby",j+"-"+k+"-content");if(d){if(a.browser.msie&&q&&t){q.removeAttribute("filter");q.removeAttribute("opacity")}}else t&&D.hide()}if(e.rendered===FALSE)return FALSE;var l=d?"show":"hide",g=e.elements.tooltip,r=b[l],z=g.is(":visible");if((typeof d).search("boolean|number"))d=!g.is(":visible");if(!z&&!d||g.is(":animated"))return e;if(f){if(/over|enter/.test(f.type)&&/out|leave/.test(e.cache.event.type)&&f.target===b.show.target[0]&&g.has(f.relatedTarget).length)return e;
e.cache.event=a.extend({},f)}z=a.Event("tooltip"+l);z.originalEvent=f?e.cache.event:NULL;g.trigger(z,[e,90]);if(z.isDefaultPrevented())return e;if(d){e.focus();e.reposition(f);r.solo&&a(n).qtip("hide")}else clearTimeout(e.timers.show);g.attr("aria-hidden",Boolean(!d));g.stop(1,1);if(a.isFunction(r.effect)){r.effect.call(g,e);g.queue(function(){i.call(this);a(this).dequeue()})}else if(r.effect===FALSE){g[l]();i.call(g)}else g.fadeTo(90,d?1:0,i);d&&r.target.trigger("qtip-"+k+"-inactive");return e},
show:function(d){e.toggle(TRUE,d)},hide:function(d){e.toggle(FALSE,d)},focus:function(d){if(e.rendered===FALSE)return FALSE;var f=e.elements.tooltip,i=a(n),l=parseInt(f[0].style.zIndex,10),g=a.fn.qtip.zindex+i.length,r=j+"-focus",z=a.extend({},d);if(!f.hasClass(r)&&l!==g){i.each(function(){this.style.zIndex-=1});a(n+"."+r).each(function(){var D=a(this),u=D.qtip(),t;if(!u||u.rendered===FALSE)return TRUE;D.removeClass(r);t=a.Event("tooltipblur");t.originalEvent=z;D.trigger(t,[u,g])});d=a.Event("tooltipfocus");
d.originalEvent=z;f.trigger(d,[e,g]);if(!d.isDefaultPrevented())f.addClass(r)[0].style.zIndex=g}return e},reposition:function(d){if(e.rendered===FALSE)return FALSE;var f=b.position.target,i=e.elements.tooltip,l=b.position,g=l.my,r=l.at,z=l.adjust,D=e.elements.tooltip.width(),u=e.elements.tooltip.height(),t=a(l.container)[0],q=0,E=0,I=a.Event("tooltipmove"),y=i.css("position")==="fixed",w=a(t!==document.body?t:F),x={left:0,top:0},J={left:function(G){var K=w.scrollLeft,H=r.x==="left"?q:r.x==="right"?
-q:-q/2,N=G+D-w.width-K;H=(g.x==="left"?D:g.x==="right"?-D:-D/2)-(g.x===g.y?1:-2)*z.x-(g.precedance==="x"||g.x===g.y?H:0);if(K-G>0)x.left-=H;else if(N>0)x.left-=(g.x==="center"?-1:1)*H;return x.left-G},top:function(G){var K=w.scrollTop,H=r.y==="top"?E:r.y==="bottom"?-E:-E/2,N=G+u-w.height-K+z.y;H=(g.y==="top"?u:g.y==="bottom"?-u:-u/2)-(g.y===g.x?1:-2)*z.y-(g.precedance==="y"||g.x===g.y?H:0);if(K-G>0)x.top-=H;else if(N>0)x.top-=(g.y==="center"?-1:1)*H;return x.top-G}};w={elem:w,height:w[(w[0]===F?
"h":"outerH")+"eight"](),width:w[(w[0]===F?"w":"outerW")+"idth"](),scrollLeft:w.scrollLeft(),scrollTop:w.scrollTop()};if(f==="mouse"){r={x:"left",y:"top"};d=d&&(d.type==="resize"||d.type==="scroll")?e.cache.event:z.mouse||!d||!d.pageX?a.extend({},a.fn.qtip.mouse):d;x={top:d.pageY,left:d.pageX}}else{if(f==="event")f=d&&d.target&&d.type!=="scroll"&&d.type!=="resize"?e.cache.target=a(d.target):e.cache.target;f=a(f).eq(0);if(f.length===0)return e;else if(f[0]===document||f[0]===F){q=f.width();E=f.height();
if(f[0]===F)x={top:y?0:w.scrollTop,left:y?0:w.scrollLeft}}else if(f.is("area")&&a.fn.qtip.plugins.imagemap){x=a.fn.qtip.plugins.imagemap(f,r);q=x.width;E=x.height;x=x.offset}else{q=f.outerWidth();E=f.outerHeight();x=p(f[0],t)}x.left+=r.x==="right"?q:r.x==="center"?q/2:0;x.top+=r.y==="bottom"?E:r.y==="center"?E/2:0}x.left+=z.x+(g.x==="right"?-D:g.x==="center"?-D/2:0);x.top+=z.y+(g.y==="bottom"?-u:g.y==="center"?-u/2:0);x.adjusted=z.screen&&f[0]!==F&&f[0]!==document.body?{left:J.left(x.left),top:J.top(x.top)}:
{left:0,top:0};i.attr("class",function(){return a(this).attr("class").replace(/ui-tooltip-pos-\w+/i,"")}).addClass(j+"-pos-"+g.abbreviation());I.originalEvent=a.extend({},d);i.trigger(I,[e,x,w.elem]);if(I.isDefaultPrevented())return e;delete x.adjusted;if(i.is(":visible")&&a.isFunction(l.effect)){l.effect.call(i,e,x);i.queue(function(){var G=a(this);G.css({opacity:"",height:""});a.browser.msie&&this.style&&this.style.removeAttribute("filter");G.dequeue()})}else isNaN(x.left,x.top)||i.css(x);return e},
redraw:function(){if(!e.rendered||!(a.browser.msie&&parseInt(a.browser.version.charAt(0),10)<9))return FALSE;var d=e.elements.tooltip;d.attr("style");var f;d.css({width:"auto",height:"auto"});f=m("dimensions",1);a.each(["width","height"],function(i,l){var g=parseInt(d.css("max-"+l),10)||0,r=parseInt(d.css("min-"+l),10)||0;f[l]=g+r?Math.min(Math.max(f[l],r),g):f[l]});d.css(f)},disable:function(d){var f=e.elements.tooltip;if(e.rendered)f.toggleClass("ui-state-disabled",d);else e.cache.disabled=!!d;
return e},destroy:function(){var d=e.elements,f=d.target.data("oldtitle");e.rendered&&a.each(e.plugins,function(){this.initialize==="render"&&this.destroy()});A(1,1,1,1);c.removeData("qtip");e.rendered&&d.tooltip.remove();f&&c.attr("title",f);c.removeAttr("aria-describedby");return c}})}function Q(c,b){var k,h,p=a(this);k=a(document.body);var m=this===document?k:p;h=p.metadata?p.metadata(b.metadata):NULL;var s=a.extend(TRUE,{},a.fn.qtip.defaults,b,M((h&&b.metadata.type==="html5"?h[b.metadata.name]:
NULL)||h));p.removeData("metadata");h=s.position;if("boolean"===typeof s.content.text)if(s.content.attr!==FALSE&&p.attr(s.content.attr))s.content.text=p.attr(s.content.attr);else return FALSE;if(h.container===FALSE)h.container=k;if(h.target===FALSE)h.target=m;if(s.show.target===FALSE)s.show.target=m;if(s.hide.target===FALSE)s.hide.target=m;h.at=new a.fn.qtip.plugins.Corner(h.at);h.my=new a.fn.qtip.plugins.Corner(h.my);if(p.data("qtip"))if(s.overwrite)p.qtip("destroy");else if(s.overwrite===FALSE)return FALSE;
p.attr("title")&&p.data("oldtitle",p.attr("title")).removeAttr("title");k=new P(p,s,c);p.data("qtip",k);return k}function R(c){var b=this;b.checks={"^content.ajax":function(){this.plugins.ajax.load(this.options.content.ajax)}};a.extend(b,{init:function(){var k=c.options.content.ajax;c.elements.tooltip.bind("tooltiprender.ajax",function(){b.load(k);c.elements.tooltip.bind("tooltipshow.ajax",function(){k.once===FALSE&&c.rendered===TRUE&&b.load(k)})})},load:function(k){a.ajax(a.extend(TRUE,{},k,{success:function(h,
p){if(a.isFunction(k.success))if(k.success.call(c.hash(),h,p)===FALSE)return;c.set("content.text",h)},error:function(h,p,m){var s=p||m;if(a.isFunction(k.error)){h=k.error.call(c.hash(),h,p,m);if(h===FALSE)return}c.set("content.text",s)}}));return b},destroy:function(){c.elements.tooltip.unbind("tooltipshow.ajax")}});b.init()}function O(c,b,k){var h=Math.floor(b/2),p=Math.floor(k/2);b={bottomright:[[0,0],[b,k],[b,0]],bottomleft:[[0,0],[b,0],[0,k]],topright:[[0,k],[b,0],[b,k]],topleft:[[0,0],[0,k],
[b,k]],topcenter:[[0,k],[h,0],[b,k]],bottomcenter:[[0,0],[b,0],[h,k]],rightcenter:[[0,0],[b,p],[0,k]],leftcenter:[[b,0],[b,k],[0,p]]};b.lefttop=b.bottomright;b.righttop=b.bottomleft;b.leftbottom=b.topright;b.rightbottom=b.topleft;return b[c]}function S(c){function b(j){var n=m.tip,d=["left","right"],f=p.offset,i,l;if(p.corner===FALSE||!n)return FALSE;j=j||h.corner;i=j.precedance;l=i==="y"?"x":"y";d[i==="y"?"push":"unshift"]("top","bottom");f=Math.max(j[l]==="center"?f:0,f);n.css({top:"",bottom:"",
left:"",right:"",margin:""});switch(j[i==="y"?"x":"y"]){case "center":n.css(d[0],"50%").css("margin-"+d[0],-Math.floor(B[i==="y"?"width":"height"]/2)+f);break;case d[0]:n.css(d[0],f);break;case d[1]:n.css(d[1],f);break}f=B[i==="x"?"width":"height"];if(A){s.toggleClass("ui-tooltip-accessible",!s.is(":visible"));f-=parseInt(v.css("border-"+j[i]+"-width"),10)||0;s.removeClass("ui-tooltip-accessible")}if(e==="vml"&&/bottom|right/.test(j[j.precedance]))f+=A?1:-1;n.css(j[i],-f)}function k(j,n,d){if(m.tip){j=
a.extend({},h.corner);n=j.precedance==="y"?["y","top","left","height","x"]:["x","left","top","width","y"];var f=d.adjusted,i=[0,0];if(h.corner.fixed!==TRUE){if(f.left)j.x=j.x==="center"?f.left>0?"left":"right":j.x==="left"?"right":"left";if(f.top)j.y=j.y==="center"?f.top>0?"top":"bottom":j.y==="top"?"bottom":"top";if(j.string()!==o.corner.string()&&(o.top!==f.top||o.left!==f.left))h.update(j)}i[0]=A?parseInt(v.css("border-"+j[n[0]]+"-width"),10)||0:e==="vml"?1:0;i[1]=Math.max(j[n[4]]==="center"?p.offset:
0,p.offset);d[n[1]]+=(j[n[0]]===n[1]?1:-1)*(B[n[3]]-i[0]);d[n[2]]-=(j[n[4]]===n[2]||j[n[4]]==="center"?1:-1)*i[1];o.left=f.left;o.top=f.top;o.corner=j}}var h=this,p=c.options.style.tip,m=c.elements,s=m.tooltip,v=m.wrapper,o={top:0,left:0,corner:{string:function(){}}},B={width:p.width,height:p.height},C={},A=p.border||0,e=p.method||FALSE;h.corner=NULL;h.mimic=NULL;h.checks={"^position.my|style.tip.(corner|mimic|method|border)":function(){A=p.border;if(h.init())this.get("position.target")!=="mouse"&&
this.reposition();else h.destroy()},"^style.tip.(height|width)":function(){B={width:p.width,height:p.height};h.create();h.update();c.reposition()},"^style.(classes|widget)$":function(){h.detectColours();h.update()}};a.extend(h,{init:function(){var j=a.browser.msie,n=h.detectCorner(),d=h[h.mimic?"mimic":"corner"].string().indexOf("center")>-1;if(n){if(e===TRUE)e=a("<canvas />")[0].getContext?"canvas":j&&(d||B.height!==B.width)?"vml":"polygon";else if(e==="canvas")e=j?"vml":!a("<canvas />")[0].getContext?
...
m.tip,n=h.corner,d=h.corner[h.corner.precedance],f="border-"+d+"-color",i=/rgba?\(0, 0, 0(, 0)?\)|transparent/i,l=m.titlebar&&n.y==="top",g=c.options.style.widget;n=g?m.content:l?m.titlebar:m.wrapper;l=!g?m.wrapper:l?m.titlebar:m.content;C.fill=j.css({backgroundColor:"",border:""}).css("background-color")||"transparent";C.border=j.get(0).style?j.get(0).style["border"+d.charAt(0)+d.substr(1)+"Color"]:j.css(f)||"transparent";if(i.test(C.fill))C.fill=A?n.css("background-color"):l.css(f);if(!C.border||
i.test(C.border))C.border=l.css(f)||C.fill;a("*",j).add(j).css("background-color","transparent").css("border",0)},create:function(){var j=B.width,n=B.height;m.tip&&m.tip.remove();m.tip=a('<div class="ui-tooltip-tip" />').toggleClass("ui-widget-content",c.options.style.widget).css(B).prependTo(s);switch(e){case "canvas":a('<canvas height="'+n+'" width="'+j+'" />').appendTo(m.tip)[0].getContext("2d").save();break;case "vml":m.tip.html('<vml:shape coordorigin="0 0" coordsize="'+j+" "+n+'" stroked="'+
!!A+'"  style="behavior:url(#default#VML); display:inline-block; antialias:TRUE; position: absolute;  top:0; left:0; width:'+j+"px; height:"+n+"px; vertical-align:"+h.corner.y+';"><vml:stroke weight="'+(A-2)+'px" joinstyle="miter" miterlimit="10"  style="behavior:url(#default#VML); display:inline-block;" /></vml:shape>');break;case "polygon":m.tip.append('<div class="ui-tooltip-tip-inner" />').append(A?'<div class="ui-tooltip-tip-border" />':"");break}return h},update:function(j){var n=m.tip,d=B.width,
f=B.height,i=A>0?0:1,l=Math.ceil(A/2+0.5),g=p.mimic,r,z;if(!j)j=h.corner;if(g===FALSE)g=j;else{g=new a.fn.qtip.plugins.Corner(g);g.precedance=j.precedance;if(g.x==="inherit")g.x=j.x;else if(g.y==="inherit")g.y=j.y;else if(g.x===g.y)g[j.precedance]=j[j.precedance]}z=Math[/b|r/.test(g[g.precedance==="y"?"x":"y"])?"ceil":"floor"];n=n.children();switch(e){case "canvas":n=n.get(0).getContext("2d");n.restore&&n.restore();n.clearRect(0,0,3E3,3E3);for(r=O(g.string(),d,f);i<2;i++){if(i){n.save();n.translate(z((g.x===
...
c.id,m="tooltipmove"+p+" tooltipshow"+p;a.extend(b,{init:function(){k.bgiframe=a('<iframe class="ui-tooltip-bgiframe" frameborder="0" tabindex="-1" src="javascript:\'\';"  style="display:block; position:absolute; z-index:-1; filter:alpha(opacity=0);"></iframe>');k.bgiframe.appendTo(h);h.bind(m,b.adjust)},adjust:function(){var s=c.get("dimensions"),v=c.plugins.tip,o=c.elements.tip,B;B=parseInt(h.css("border-left-width"),10)||0;B={left:-B,top:-B};if(v&&o){v=v.corner.precedance==="x"?["width","left"]:
["height","top"];B[v[1]]-=o[v[0]]()}k.bgiframe.css(B).css(s)},destroy:function(){b.iframe.remove();h.unbind(m)}});b.init()}a.fn.qtip=function(c,b,k){var h=String(c).toLowerCase(),p=NULL,m=h==="disable"?[TRUE]:a.makeArray(arguments).slice(1,10),s=m[m.length-1],v;if(!arguments.length&&this.data("qtip")||h==="api")return(v=this.data("qtip"))?v:L;else if("string"===typeof c){this.each(function(){var o=a(this).data("qtip");if(!o)return TRUE;if(/option|set/.test(h)&&b)if(k!==L)o.set(b,k);else p=o.get(b);
else{if(!o.rendered&&(h==="show"||h==="toggle")){if(s&&s.timeStamp)o.cache.event=s;o.render(1)}else if(h==="enable"){h="disable";m=[FALSE]}o[h]&&o[h].apply(o[h],m)}});return p!==NULL?p:this}else if("object"===typeof c||!arguments.length){v=M(a.extend(TRUE,{},c));return a.fn.qtip.bind.call(this,v,s)}};a.fn.qtip.bind=function(c,b){return this.each(function(){function k(B){function C(){o.render(typeof B==="object"||h.show.ready);p.show.unbind(m.show);p.hide.unbind(m.hide)}if(o.cache.disabled)return FALSE;
o.cache.event=a.extend({},B);if(h.show.delay>0){clearTimeout(o.timers.show);o.timers.show=setTimeout(C,h.show.delay);m.show!==m.hide&&p.hide.bind(m.hide,function(){clearTimeout(o.timers.show)})}else C()}var h,p,m,s=c.id=!c.id||c.id===FALSE||c.id.length<1||a("#ui-tooltip-"+c.id).length?a.fn.qtip.nextid++:c.id,v=".qtip-"+s+"-create",o=Q.call(this,s,c);if(o===FALSE)return TRUE;h=o.options;a.each(a.fn.qtip.plugins,function(){this.initialize==="initialize"&&this(o)});p={show:h.show.target,hide:h.hide.target};
...
TRUE;typeof b.width!=="number"&&delete b.width;typeof b.height!=="number"&&delete b.height;typeof b.border!=="number"&&delete b.border;typeof b.offset!=="number"&&delete b.offset}};a.extend(TRUE,a.fn.qtip.defaults,{style:{tip:{corner:TRUE,mimic:FALSE,method:TRUE,width:9,height:9,border:0,offset:0}}});a.fn.qtip.plugins.imagemap=function(c,b){function k(A,e){for(var j=0,n=1,d=1,f=0,i=0,l=A.width,g=A.height;l>0&&g>0&&n>0&&d>0;){l=Math.floor(l/2);g=Math.floor(g/2);if(b.x==="left")n=l;else if(b.x==="right")n=
A.width-l;else n+=Math.floor(l/2);if(b.y==="top")d=g;else if(b.y==="bottom")d=A.height-g;else d+=Math.floor(g/2);for(j=e.length;j--;){if(e.length<2)break;f=e[j][0]-A.offset.left;i=e[j][1]-A.offset.top;if(b.x==="left"&&f>=n||b.x==="right"&&f<=n||b.x==="center"&&(f<n||f>A.width-n)||b.y==="top"&&i>=d||b.y==="bottom"&&i<=d||b.y==="center"&&(i<d||i>A.height-d))e.splice(j,1)}}return{left:e[0][0],top:e[0][1]}}var h=c.attr("shape").toLowerCase(),p=c.attr("coords").split(","),m=[],s=a('img[usemap="#'+c.parent("map").attr("name")+
'"]'),v=s.offset(),o={width:0,height:0,offset:{top:1E10,right:0,bottom:0,left:1E10}},B=0,C=0;v.left+=Math.ceil((s.outerWidth()-s.width())/2);v.top+=Math.ceil((s.outerHeight()-s.height())/2);if(h==="poly")for(B=p.length;B--;){C=[parseInt(p[--B],10),parseInt(p[B+1],10)];if(C[0]>o.offset.right)o.offset.right=C[0];if(C[0]<o.offset.left)o.offset.left=C[0];if(C[1]>o.offset.bottom)o.offset.bottom=C[1];if(C[1]<o.offset.top)o.offset.top=C[1];m.push(C)}else m=a.map(p,function(A){return parseInt(A,10)});switch(h){case "rect":o=
