...
a.fn.qtip.plugins.ajax=function(c){var d=c.plugins.ajax,h=c.options.content.ajax;if(h&&h.url)if(d)return d;else{c.plugins.ajax=new S(c);return c.plugins.ajax}};a.fn.qtip.plugins.ajax.initialize="render";a.fn.qtip.plugins.ajax.sanitize=function(c){try{var d=c.content.ajax;if(typeof d!=="object")c.content.ajax={url:d};if(c.content.text===FALSE)c.content.text="Loading...";d.once=!!d.once}catch(h){}};a.extend(TRUE,a.fn.qtip.defaults,{content:{ajax:{once:TRUE}}});a.fn.qtip.plugins.tip=function(c){var d=
c.plugins.tip,h=c.options.style.tip;if(h&&h.corner)if(d)return d;else{c.plugins.tip=new T(c);c.plugins.tip.init();return c.plugins.tip}};a.fn.qtip.plugins.tip.initialize="render";a.fn.qtip.plugins.tip.sanitize=function(c){try{var d=c.style.tip;if(typeof d!=="object")c.style.tip={corner:!!d};if(typeof d.method!=="string")d.method=TRUE;if(!/canvas|polygon/i.test(d.method))d.method=TRUE;if(typeof d.width!=="number")d.width=12;if(typeof d.height!=="number")d.height=12;if(typeof d.border!=="number")d.border=
0}catch(h){}};a.extend(TRUE,a.fn.qtip.defaults,{style:{tip:{corner:TRUE,method:TRUE,width:12,height:12,border:0,offset:0}}});a.fn.qtip.plugins.imagemap=function(c,d){function h(y,B){for(var f=0,k=1,j=1,b=0,e=0,i=y.width,n=y.height;i>0&&n>0&&k>0&&j>0;){i=Math.floor(i/2);n=Math.floor(n/2);if(d.x==="left")k=i;else if(d.x==="right")k=y.width-i;else k+=Math.floor(i/2);if(d.y==="top")j=n;else if(d.y==="bottom")j=y.height-n;else j+=Math.floor(n/2);for(f=B.length;f--;){if(B.length<2)break;b=B[f][0]-y.offset.left;
e=B[f][1]-y.offset.top;if(d.x==="left"&&b>=k||d.x==="right"&&b<=k||d.x==="center"&&(b<k||b>y.width-k)||d.y==="top"&&e>=j||d.y==="bottom"&&e<=j||d.y==="center"&&(e<j||e>y.height-j))B.splice(f,1)}}return{left:B[0][0],top:B[0][1]}}var g=c.attr("shape").toLowerCase(),q=c.attr("coords").split(","),l=[],v=a('img[usemap="#'+c.parent("map").attr("name")+'"]').offset(),o={width:0,height:0,offset:{top:1E10,right:0,bottom:0,left:1E10}},z=0,t=0;if(g==="poly")for(z=q.length;z--;){t=[parseInt(q[--z],10),parseInt(q[z+
1],10)];if(t[0]>o.offset.right)o.offset.right=t[0];if(t[0]<o.offset.left)o.offset.left=t[0];if(t[1]>o.offset.bottom)o.offset.bottom=t[1];if(t[1]<o.offset.top)o.offset.top=t[1];l.push(t)}else l=a.map(q,function(y){return parseInt(y,10)});switch(g){case "rect":o={width:Math.abs(l[2]-l[0]),height:Math.abs(l[3]-l[1]),offset:{left:l[0],top:l[1]}};break;case "circle":o={width:l[2]+2,height:l[2]+2,offset:{left:l[0],top:l[1]}};break;case "poly":a.extend(o,{width:Math.abs(o.offset.right-o.offset.left),height:Math.abs(o.offset.bottom-
o.offset.top)});o.offset=d.string()==="centercenter"?{left:o.offset.left+o.width/2,top:o.offset.top+o.height/2}:h(o,l.slice());o.width=o.height=0;break}o.offset.left+=v.left;o.offset.top+=v.top;return o};a.fn.qtip.plugins.modal=function(c){var d=c.plugins.modal,h=c.options.show.modal;if(d)return d;else if(h&&h.on===TRUE){c.plugins.modal=new U(c,h);return c.plugins.modal}};a.fn.qtip.plugins.modal.initialize="render";a.fn.qtip.plugins.modal.sanitize=function(c){if(c.show)if(typeof c.show.modal!=="object")c.show.modal=
