...
A);A()})}else if(r.effect===l){i[m]();g.call(i)}else i.fadeTo(90,c?1:0,g);c&&r.target.trigger("qtip-"+q+"-inactive");return b},show:function(c){b.toggle(t,c)},hide:function(c){b.toggle(l,c)},focus:function(c){if(b.rendered===l)return l;var f=b.elements.tooltip,g=d(Q),m=parseInt(f[0].style.zIndex,10),i=d.fn.qtip.zindex+g.length,r=H+"-focus",p=d.extend({},c);if(!f.hasClass(r)&&m!==i){g.each(function(){this.style.zIndex-=1;this.removeAttribute("tabIndex")});d(Q+"."+r).each(function(){var A=d(this),B=
A.qtip(),w;if(!B||B.rendered===l)return t;A.removeClass(r);w=d.Event("tooltipblur");w.originalEvent=p;A.trigger(w,[B,i])});c=d.Event("tooltipfocus");c.originalEvent=p;f.trigger(c,[b,i]);if(!c.isDefaultPrevented()){f.addClass(r)[0].style.zIndex=i;f[0].tabIndex=-1}}return b},reposition:function(c,f){if(b.rendered===l)return l;var g=a.position.target,m=b.elements.tooltip,i=a.position,r=i.my,p=i.at,A=i.adjust,B=b.elements.tooltip.outerWidth(),w=b.elements.tooltip.outerHeight(),u=0,I=0,P=d.Event("tooltipmove"),
D=m.css("position")==="fixed",C=i.viewport.jquery?i.viewport:d(K),x={left:0,top:0},R={left:function(L){var J=C.scrollLeft,N=p.x==="left"?u:p.x==="right"?-u:-u/2,S=J-L;J=L+B-C.width-J;N=(r.x==="left"?B:r.x==="right"?-B:-B/2)-(r.precedance==="x"||r.x===r.y?N:0);if(S>0&&(r.x!=="left"||J>0))x.left-=N;else if(J>0&&(r.x!=="right"||S>0))x.left-=(r.x==="center"?-1:1)*N+2*A.x;if(x.left<0&&-x.left>J)x.left=L;return x.left-L},top:function(L){var J=C.scrollTop,N=p.y==="top"?I:p.y==="bottom"?-I:-I/2,S=J-L;J=L+
w-C.height-J;N=(r.y==="top"?w:r.y==="bottom"?-w:-w/2)-(r.precedance==="y"||r.x===r.y?N:0);if(S>0&&(r.y!=="top"||J>0))x.top-=N;else if(J>0&&(r.y!=="bottom"||S>0))x.top-=(r.y==="center"?-1:1)*N+2*A.y;if(x.top<0&&-x.top>J)x.top=L;return x.top-L}};f=f===O||!!f||l;C=!C?l:{elem:C,height:C[(C[0]===K?"h":"outerH")+"eight"](),width:C[(C[0]===K?"w":"outerW")+"idth"](),scrollLeft:C.scrollLeft(),scrollTop:C.scrollTop()};if(g==="mouse"){p={x:"left",y:"top"};c=c&&(c.type==="resize"||c.type==="scroll")?b.cache.event:
A.mouse||!c||!c.pageX?d.extend({},d.fn.qtip.mouse):c;x={top:c.pageY,left:c.pageX}}else{if(g==="event")g=c&&c.target&&c.type!=="scroll"&&c.type!=="resize"?b.cache.target=d(c.target):b.cache.target;g=d(g).eq(0);if(g.length===0)return b;else if(g[0]===document||g[0]===K){u=g.width();I=g.height();if(g[0]===K)x={top:D?0:C.scrollTop,left:D?0:C.scrollLeft}}else if(g.is("area")&&d.fn.qtip.plugins.imagemap){x=d.fn.qtip.plugins.imagemap(g,p);u=x.width;I=x.height;x=x.offset}else{u=g.outerWidth();I=g.outerHeight();
x=n(g[0],i.container[0])}x.left+=p.x==="right"?u:p.x==="center"?u/2:0;x.top+=p.y==="bottom"?I:p.y==="center"?I/2:0}x.left+=A.x+(r.x==="right"?-B:r.x==="center"?-B/2:0);x.top+=A.y+(r.y==="bottom"?-w:r.y==="center"?-w/2:0);x.adjusted=i.viewport.jquery&&g[0]!==K&&g[0]!==z?{left:R.left(x.left),top:R.top(x.top)}:{left:0,top:0};m.attr("class",function(){return d(this).attr("class").replace(/ui-tooltip-pos-\w+/i,"")}).addClass(H+"-pos-"+r.abbreviation());P.originalEvent=d.extend({},c);m.trigger(P,[b,x,C.elem]);
if(P.isDefaultPrevented())return b;delete x.adjusted;if(!f||!isNaN(x.left,x.top))m.css(x);else if(j()&&d.isFunction(i.effect)){i.effect.call(m,b,x);m.queue(function(L){d(this).css({opacity:"",height:""});d.browser.msie&&this.style&&this.style.removeAttribute("filter");L()})}return b},redraw:function(){if(!b.rendered||!(d.browser.msie&&parseInt(d.browser.version.charAt(0),10)<9))return l;var c=b.elements.tooltip,f=H+"-fluid",g;c.css({width:"auto",height:"auto"}).addClass(f);g={height:c.outerHeight(),
width:c.outerWidth()};d.each(["width","height"],function(m,i){var r=parseInt(c.css("max-"+i),10)||0,p=parseInt(c.css("min-"+i),10)||0;g[i]=r+p?Math.min(Math.max(g[i],p),r):g[i]});c.css(g).removeClass(f)},disable:function(c){var f=b.elements.tooltip,g=M;if("boolean"!==typeof c)c=!(f.hasClass(g)||b.cache.disabled);if(b.rendered)f.toggleClass(g,c);else b.cache.disabled=!!c;return b},destroy:function(){var c=b.elements,f=c.target.data("oldtitle");if(b.rendered){c.tooltip.remove();d.each(b.plugins,function(){this.initialize===
"render"&&this.destroy()})}clearTimeout(b.timers.show);clearTimeout(b.timers.hide);k(1,1,1,1);e.removeData("qtip");f&&e.attr("title",f);e.removeAttr("aria-describedby");return e}})}function Y(e,a){var q,h,n=d(this),j=d(document.body),v=this===document?j:n;h=n.metadata?n.metadata(a.metadata):F;var s=d.extend(t,{},d.fn.qtip.defaults,a,T((h&&a.metadata.type==="html5"?h[a.metadata.name]:F)||h));n.removeData("metadata");h=s.position;if("boolean"===typeof s.content.text)if(s.content.attr!==l&&n.attr(s.content.attr))s.content.text=
n.attr(s.content.attr);else return l;if(h.container===l)h.container=j;if(h.target===l)h.target=v;if(s.show.target===l)s.show.target=v;if(s.hide.target===l)s.hide.target=v;if(s.position.viewport===t)s.position.viewport=h.container;h.at=new d.fn.qtip.plugins.Corner(h.at);h.my=new d.fn.qtip.plugins.Corner(h.my);if(n.data("qtip"))if(s.overwrite)n.qtip("destroy");else if(s.overwrite===l)return l;n.attr("title")&&n.data("oldtitle",n.attr("title")).removeAttr("title");q=new X(n,s,e);n.data("qtip",q);n.bind("remove.qtip",
function(){q.destroy()});return q}function Z(e){var a=this,q=e.elements.tooltip,h=e.options.content.ajax;a.checks={"^content.ajax":function(n,j){if(j==="once")a.once();else h&&h.url&&a.load()}};d.extend(a,{init:function(){if(h&&h.url){a.load();a.once()}},once:function(){h.once?a.destroy():q.bind("tooltipshow.ajax",function(){a.load()})},load:function(){d.ajax(d.extend({success:function(n){e.set("content.text",n)},error:function(n,j,v){e.set("content.text",j+": "+v)},context:e},h));return a},destroy:function(){q.unbind(".ajax")}});
a.init()}function W(e,a,q){var h=Math.ceil(a/2),n=Math.ceil(q/2);a={bottomright:[[0,0],[a,q],[a,0]],bottomleft:[[0,0],[a,0],[0,q]],topright:[[0,q],[a,0],[a,q]],topleft:[[0,0],[0,q],[a,q]],topcenter:[[0,q],[h,0],[a,q]],bottomcenter:[[0,0],[a,0],[h,q]],rightcenter:[[0,0],[a,n],[0,q]],leftcenter:[[a,0],[a,q],[0,n]]};a.lefttop=a.bottomright;a.righttop=a.bottomleft;a.leftbottom=a.topright;a.rightbottom=a.topleft;return a[e.string()]}function $(e){function a(k,b,z){if(j.tip){k=d.extend({},h.corner);b=z.adjusted;
var c;if(h.corner.fixed!==t){if(b.left)k.x=k.x==="center"?b.left>0?"left":"right":k.x==="left"?"right":"left";if(b.top)k.y=k.y==="center"?b.top>0?"top":"bottom":k.y==="top"?"bottom":"top";if(k.string()!==s.corner&&(s.top!==b.top||s.left!==b.left))c=h.update(k)}c||(c=h.position(k,0));if(c.right!==O)c.left=c.right;if(c.bottom!==O)c.top=c.bottom;c.option=Math.max(0,n.offset);z.left-=c.left.charAt?c.option:(c.right?-1:1)*c.left;z.top-=c.top.charAt?c.option:(c.bottom?-1:1)*c.top;s.left=b.left;s.top=b.top;
...
{width:n.width,height:n.height};h.create();h.update();e.reposition()},"^content.title.text|style.(classes|widget)$":function(){j.tip&&h.update()}};d.extend(h,{init:function(){var k=h.detectCorner();if(k){if(G!=="polygon")G=d("<canvas />")[0].getContext?"canvas":d.browser.msie?"vml":"polygon";h.create();h.update();v.unbind(".qtip-tip").bind("tooltipmove.qtip-tip",a)}return k},detectCorner:function(){var k=n.corner,b=e.options.position,z=b.at;b=b.my.string?b.my.string():b.my;if(k===l||b===l&&z===l)return l;
else if(k===t)h.corner=new d.fn.qtip.plugins.Corner(b);else if(!k.string){h.corner=new d.fn.qtip.plugins.Corner(k);h.corner.fixed=t}return h.corner.string()!=="centercenter"},detectColours:function(){var k=j.tip.css({backgroundColor:"",border:""}),b=h.corner,z=b[b.precedance],c="border-"+z+"-color";z="border"+z.charAt(0)+z.substr(1)+"Color";var f=/rgba?\(0, 0, 0(, 0)?\)|transparent/i;b=j.titlebar&&(b.y==="top"||b.y==="center"&&k.position().top+o.height/2+n.offset<j.titlebar.outerHeight(1))?j.titlebar:
j.content;y.fill=k.css("background-color")||"transparent";y.border=k[0].style[z];if(!y.fill||f.test(y.fill)){y.fill=b.css("background-color");if(f.test(y.fill))y.fill=v.css("background-color")}if(!y.border||f.test(y.border)){y.border=v.css(c);if(f.test(y.border)||y.border===d(document.body).css("color"))y.border=b.css(c)||y.fill}d("*",k).add(k).css("background-color","transparent").css("border",0)},create:function(){var k=o.width,b=o.height;j.tip&&j.tip.remove();j.tip=d("<div />",{"class":"ui-tooltip-tip"}).css(o).prependTo(v);
switch(G){case "canvas":d('<canvas height="'+b+'" width="'+k+'" />').appendTo(j.tip)[0].getContext("2d").save();break;case "vml":k='<vml:shape coordorigin="0,0" coordsize="'+k+" "+b+'" stroked="false"  style="behavior:url(#default#VML); display:inline-block; position:absolute; antialias:false; left: 0; top: 0; width:'+k+"px; height:"+b+'px;"></vml:shape>';j.tip.html(E?k+=k:k);break;case "polygon":j.tip.append('<div class="ui-tooltip-tip-inner" />').append(E?'<div class="ui-tooltip-tip-border" />':
"");break}},update:function(k){var b=j.tip.children(),z=o.width,c=o.height,f=n.mimic,g,m,i,r,p;if(!k)k=h.corner;if(f===l)f=k;else{f=new d.fn.qtip.plugins.Corner(f);f.precedance=k.precedance;if(f.x==="inherit")f.x=k.x;else if(f.y==="inherit")f.y=k.y;else if(f.x===f.y)f[k.precedance]=k[k.precedance]}E=n.border===t?q(k,F,t):n.border;g=E>0?0:1;r=f.string().indexOf("center")>-1;p=Math[/b|r/.test(f[f.precedance==="y"?"x":"y"])?"ceil":"floor"];k=h.position(k,1);h.detectColours();switch(G){case "canvas":m=
b[0].getContext("2d");m.restore&&m.restore();m.clearRect(0,0,3E3,3E3);for(i=W(f,z,c);g<2;g++){if(g){m.save();m.translate(p((f.x==="left"?1:f.x==="right"?-1:0)*(E+1)*(f.precedance==="y"?0.5:1)),p((f.y==="top"?1:f.y==="bottom"?-1:0)*(E+1)*(f.precedance==="x"?0.5:1)))}m.beginPath();m.moveTo(i[0][0],i[0][1]);m.lineTo(i[1][0],i[1][1]);m.lineTo(i[2][0],i[2][1]);m.closePath();m.fillStyle=y[g?"fill":"border"];m.fill()}break;case "vml":i=W(f,z,c);i="m"+i[0][0]+","+i[0][1]+" l"+i[1][0]+","+i[1][1]+" "+i[2][0]+
","+i[2][1]+" xe";b.each(function(A){d(this).attr({path:i,fillcolor:y[A||!E?"fill":"border"]}).css("antialias",""+r)});break;case "polygon":b.removeAttr("style").css({position:"absolute",left:0,top:0}).each(function(A){var B={x:f.precedance==="x"?f.x==="left"?"right":"left":f.x,y:f.precedance==="y"?f.y==="top"?"bottom":"top":f.y},w=f.x==="center"?["left","right",B.y,c,z]:["top","bottom",B.x,z,c];A=y[!A&&E?"border":"fill"];f.x==="center"||f.y==="center"?d(this).css("border-"+w[2],w[3]+"px solid "+
A).css("border-"+w[0],p(w[4]/2)+"px dashed transparent").css("border-"+w[1],p(w[4]/2)+"px dashed transparent"):d(this).css("border-width",p(c/2)+"px "+p(z/2)+"px").css("border-"+B.x,p(z/2)+"px solid "+A).css("border-"+B.y,p(c/2)+"px solid "+A)});break}if(G!=="canvas"&&E){g=[E*2.75,E];g=f.precedance==="y"?[f.x==="left"?g[1]:f.x==="right"?-g[1]:0,f.y==="bottom"?-g[0]:g[0]]:[f.x==="left"?g[0]:-g[0],f.y==="bottom"?-g[1]:f.y==="top"?g[1]:0];b.eq(1).css({left:g[0],top:g[1]})}return k},position:function(k,
b){var z=j.tip,c={},f=Math.max(0,n.offset),g,m;if(n.corner===l||!z)return l;k=k||h.corner;g=k.precedance;m=o[g==="x"?"width":"height"];d.each(g==="y"?[k.x,k.y]:[k.y,k.x],function(i,r){var p;if(r==="center"){p=g==="y"?"left":"top";c[p]="50%";c["margin-"+p]=-Math.floor(m/2)+f}else{p=q(k,r,t);if(i||E===O)p=q(k,r);else{if(p)p=0;else{p=d.browser.mozilla;var A=k.y+(p?"":"-")+k.x;p=(p?"-moz-":d.browser.webkit?"-webkit-":"")+(p?"border-radius-"+A:"border-"+A+"-radius");p=parseInt((j.titlebar&&k.y==="top"?
j.titlebar:j.content).css(p),10)||parseInt(v.css(p),10)||0}p=f+p}c[r]=p}});c[k[g]]-=m;b&&z.css({top:"",bottom:"",left:"",right:"",margin:""}).css(c);return c},destroy:function(){j.tip&&j.tip.remove();v.unbind(".qtip-tip")}});h.init()}function aa(e){var a=this,q=e.options.show.modal,h=e.elements,n=h.tooltip;a.checks={"^show.modal.(on|blur)$":function(){a.init();h.overlay.toggle(n.is(":visible"))}};d.extend(a,{init:function(){if(q.on){n.unbind(".qtipmodal").bind("tooltipshow.qtipmodal tooltiphide.qtipmodal",
